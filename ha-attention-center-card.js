 ...
 */
const se = globalThis, Ie = se.ShadowRoot && (se.ShadyCSS === void 0 || se.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ne = Symbol(), Je = /* @__PURE__ */ new WeakMap();
let Et = class {
  constructor(e, i, r) {
  ...
  get styleSheet() {
    ...
    if (Ie && e === void 0) {
      ...
      r && (e = Je.get(i)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), r && Je.set(i, e));
    }
    return e;
  }
  toString() {
...
}, qe = Ie ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Kt, defineProperty: Wt, getOwnPropertyDescriptor: Yt, getOwnPropertyNames: Zt, getOwnPropertySymbols: Qt, getPrototypeOf: Xt } = Object, C = globalThis, Ge = C.trustedTypes, ei = Ge ? Ge.emptyScript : "", ve = C.reactiveElementPolyfillSupport, W = (t, e) => t, oe = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? ei : null;
      break;
  ...
  return i;
} }, De = (t, e) => !Kt(t, e), Ke = { attribute: !0, type: String, converter: oe, reflect: !1, useDefault: !1, hasChanged: De };
...
let H = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(W("properties"))) {
      const i = this.properties, r = [...Zt(i), ...Qt(i)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const s of r) i.unshift(qe(s));
  ...
  requestUpdate(e, i, r, s = !1, n) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (n = this[e]), r ?? (r = a.getPropertyOptions(e)), !((r.hasChanged ?? De)(n, i) || r.useDefault && r.reflect && n === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(a._$Eu(e, r)))) return;
      this.C(e, i, r);
    }
...
H.elementStyles = [], H.shadowRootOptions = { mode: "open" }, H[W("elementProperties")] = /* @__PURE__ */ new Map(), H[W("finalized")] = /* @__PURE__ */ new Map(), ve == null || ve({ ReactiveElement: H }), (C.reactiveElementVersions ?? (C.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Y = globalThis, We = (t) => t, ae = Y.trustedTypes, Ye = ae ? ae.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, xt = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, Ct = "?" + x, ti = `<${Ct}>`, O = document, Z = () => O.createComment(""), Q = (t) => t === null || typeof t != "object" && typeof t != "function", Oe = Array.isArray, ii = (t) => Oe(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", me = `[ 	
\f\r]`, J = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ze = /-->/g, Qe = />/g, k = RegExp(`>|${me}(?:([^\\s"'>=/]+)(${me}*=${me}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Xe = /'/g, et = /"/g, Mt = /^(?:script|style|textarea|title)$/i, ri = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), _ = ri(1), U = Symbol.for("lit-noChange"), v = Symbol.for("lit-nothing"), tt = /* @__PURE__ */ new WeakMap(), I = O.createTreeWalker(O, 129);
function Tt(t, e) {
...
const si = (t, e) => {
  ...
  let s, n = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", o = J;
  for (let a = 0; a < i; a++) {
    const l = t[a];
    let c, d, u = -1, p = 0;
    for (; p < l.length && (o.lastIndex = p, d = o.exec(l), d !== null); ) p = o.lastIndex, o === J ? d[1] === "!--" ? o = Ze : d[1] !== void 0 ? o = Qe : d[2] !== void 0 ? (Mt.test(d[2]) && (s = RegExp("</" + d[2], "g")), o = k) : d[3] !== void 0 && (o = k) : o === k ? d[0] === ">" ? (o = s ?? J, u = -1) : d[1] === void 0 ? u = -2 : (u = o.lastIndex - d[2].length, c = d[1], o = d[3] === void 0 ? k : d[3] === '"' ? et : Xe) : o === et || o === Xe ? o = k : o === Ze || o === Qe ? o = J : (o = k, s = void 0);
    const f = o === k && t[a + 1].startsWith("/>") ? " " : "";
    n += o === J ? l + ti : u >= 0 ? (r.push(c), l.slice(0, u) + xt + l.slice(u) + x + f) : l + x + (u === -2 ? a : f);
  }
  return [Tt(t, n + (t[i] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), r];
};
class X {
  constructor({ strings: e, _$litType$: i }, r) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const a = e.length - 1, l = this.parts, [c, d] = si(e, i);
    if (this.el = X.createElement(c, r), I.currentNode = this.el.content, i === 2 || i === 3) {
    ...
    for (; (s = I.nextNode()) !== null && l.length < a; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const u of s.getAttributeNames()) if (u.endsWith(xt)) {
          ...
          l.push({ type: 1, index: n, name: m[2], strings: f, ctor: m[1] === "." ? oi : m[1] === "?" ? ai : m[1] === "@" ? li : ue }), s.removeAttribute(u);
        ...
        if (Mt.test(s.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let f = 0; f < p; f++) s.append(u[f], Z()), I.nextNode(), l.push({ type: 2, index: ++n });
            s.append(u[p], Z());
          }
        }
...
function B(t, e, i = t, r) {
  var o, a;
  if (e === U) return e;
  let s = r !== void 0 ? (o = i._$Co) == null ? void 0 : o[r] : i._$Cl;
  const n = Q(e) ? void 0 : e._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== n && ((a = s == null ? void 0 : s._$AO) == null || a.call(s, !1), n === void 0 ? s = void 0 : (s = new n(t), s._$AT(t, i, r)), r !== void 0 ? (i._$Co ?? (i._$Co = []))[r] = s : i._$Cl = s), s !== void 0 && (e = B(t, s._$AS(t, e.values), s, r)), e;
}
class ni {
  constructor(e, i) {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (o === l.index) {
        let c;
        l.type === 2 ? c = new V(n, n.nextSibling, this, e) : l.type === 1 ? c = new l.ctor(n, l.name, l.strings, this, e) : l.type === 6 && (c = new ci(n, this, e)), this._$AV.push(c), l = r[++a];
      }
...
class V {
  ...
  _$AI(e, i = this) {
    e = B(this, e, i), Q(e) ? e === v || e == null || e === "" ? (this._$AH !== v && this._$AR(), this._$AH = v) : e !== this._$AH && e !== U && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ii(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== v && Q(this._$AH) ? this._$AA.nextSibling.data = e : this.T(O.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
    const { values: i, _$litType$: r } = e, s = typeof r == "number" ? this._$AC(e) : (r.el === void 0 && (r.el = X.createElement(Tt(r.h, r.h[0]), this.options)), r);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === s) this._$AH.p(i);
    else {
      const o = new ni(s, this), a = o.u(this.options);
      o.p(i), this.T(a), this._$AH = o;
    }
  }
  _$AC(e) {
    let i = tt.get(e.strings);
    return i === void 0 && tt.set(e.strings, i = new X(e)), i;
  }
  k(e) {
    Oe(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let r, s = 0;
    for (const n of e) s === i.length ? i.push(r = new V(this.O(Z()), this.O(Z()), this, this.options)) : r = i[s], r._$AI(n), s++;
...
class ue {
  ...
  _$AI(e, i = this, r, s) {
    ...
    let o = !1;
    if (n === void 0) e = B(this, e, i, 0), o = !Q(e) || e !== this._$AH && e !== U, o && (this._$AH = e);
    else {
      const a = e;
      let l, c;
      for (e = n[0], l = 0; l < n.length - 1; l++) c = B(this, a[r + l], i, l), c === U && (c = this._$AH[l]), o || (o = !Q(c) || c !== this._$AH[l]), c === v ? e = v : e !== v && (e += (c ?? "") + n[l + 1]), this._$AH[l] = c;
    }
    o && !s && this.j(e);
  }
  j(e) {
...
const ui = { I: V }, ge = Y.litHtmlPolyfillSupport;
ge == null || ge(X, V), (Y.litHtmlVersions ?? (Y.litHtmlVersions = [])).push("3.3.3");
const di = (t, e, i) => {
  const r = (i == null ? void 0 : i.renderBefore) ?? e;
  let s = r._$litPart$;
  if (s === void 0) {
    const n = (i == null ? void 0 : i.renderBefore) ?? null;
    r._$litPart$ = s = new V(e.insertBefore(Z(), n), n, void 0, i ?? {});
  }
  return s._$AI(t), s;
};
/**
...
var At;
j._$litElement$ = !0, j.finalized = !0, (At = N.litElementHydrateSupport) == null || At.call(N, { LitElement: j });
const be = N.litElementPolyfillSupport;
be == null || be({ LitElement: j });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const hi = { attribute: !0, type: String, converter: oe, reflect: !1, hasChanged: De }, pi = (t = hi, e, i) => {
...
function Ue(t) {
  return (e, i) => typeof i == "object" ? pi(t, e, i) : ((r, s, n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const fi = { CHILD: 2 }, _i = (t) => (...e) => ({ _$litDirective$: t, values: e });
let vi = class {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: mi } = ui, it = (t) => t, rt = () => document.createComment(""), q = (t, e, i) => {
  var n;
  const r = t._$AA.parentNode, s = e === void 0 ? t._$AB : e._$AA;
  if (i === void 0) {
    const o = r.insertBefore(rt(), s), a = r.insertBefore(rt(), s);
    i = new mi(o, a, t, t.options);
  } else {
    ...
    if (o !== s || l) {
      let c = i._$AA;
      for (; c !== o; ) {
        const d = it(c).nextSibling;
        it(r).insertBefore(c, s), c = d;
      }
    }
  }
  return i;
}, R = (t, e, i = t) => (t._$AI(e, i), t), gi = {}, bi = (t, e = gi) => t._$AH = e, yi = (t) => t._$AH, ye = (t) => {
...
const st = (t, e, i) => {
  ...
  update(t, [e, i, r]) {
    const s = yi(t), { values: n, keys: o } = this.dt(e, i, r);
    if (!Array.isArray(s)) return this.ut = o, n;
    const a = this.ut ?? (this.ut = []), l = [];
    let c, d, u = 0, p = s.length - 1, f = 0, m = n.length - 1;
    for (; u <= p && f <= m; ) if (s[u] === null) u++;
    else if (s[p] === null) p--;
    else if (a[u] === o[f]) l[f] = R(s[u], n[f]), u++, f++;
    else if (a[p] === o[m]) l[m] = R(s[p], n[m]), p--, m--;
    else if (a[u] === o[m]) l[m] = R(s[u], n[m]), q(t, l[m + 1], s[u]), u++, m--;
    else if (a[p] === o[f]) l[f] = R(s[p], n[f]), q(t, s[u], s[p]), p--, f++;
    else if (c === void 0 && (c = st(o, f, m), d = st(a, u, p)), c.has(a[u])) if (c.has(a[p])) {
      const E = d.get(o[f]), _e = E !== void 0 ? s[E] : null;
      if (_e === null) {
        const Fe = q(t, s[u]);
        R(Fe, n[f]), l[f] = Fe;
      } else l[f] = R(_e, n[f]), q(t, s[u], _e), s[E] = null;
      f++;
    } else ye(s[p]), p--;
    else ye(s[u]), u++;
    for (; f <= m; ) {
    ...
    return this.ut = o, bi(t, l), U;
  }
});
async function $i(t, e, i, r) {
  if (!(i.confirmation && !await r.confirm(`Run ${i.name ?? Rt(i)}?`))) {
...
const It = "Attention Center", Nt = 30, Dt = 15, Ot = 24, Ut = /* @__PURE__ */ new Set(["critical", "warning", "info"]), Ai = /* @__PURE__ */ new Set(["unavailable", "battery", "stale", "rule"]), Ei = /* @__PURE__ */ new Set(["full", "compact", "summary"]), Si = /* @__PURE__ */ new Set(["message", "hide"]), xi = /* @__PURE__ */ new Set(["none", "severity", "area", "source", "device"]), h = {
  title: It,
...
function Ci(t) {
  return typeof t == "string" && Ut.has(t);
}
function de(t) {
  if (!$(t))
  ...
  return {
    ...
    stale_hours: Pe(e.stale_hours, "stale_hours", Ot),
    battery_warning: s,
    battery_critical: n,
    battery_thresholds: Oi(
    ...
    availability: Ri(e.availability, i),
    display_mode: o,
    empty_state: a,
    reverse_age_sort: L(
      e.reverse_age_sort,
    ...
    group_by: Ae(e.group_by, "group_by", xi, h.group_by),
    show_severities: ot(
      e.show_severities,
      "show_severities",
      Ut,
    ...
    max_issues: Ui(e.max_issues, "max_issues"),
    collapsed_groups: S(e.collapsed_groups, "collapsed_groups"),
    include: Ti(e.include),
    exclude: ki(e.exclude),
    stale_rules: Di(e.stale_rules),
    rules: Ii(e.rules)
  };
}
function Mi(t) {
...
function Di(t) {
  ...
  return t.map((e, i) => {
    ...
    return {
      ...e,
      entity_id: Pt(e.entity_id, `stale_rules[${i}].entity_id`),
      hours: Pe(e.hours, `stale_rules[${i}].hours`),
      severity: le(e.severity, `stale_rules[${i}].severity`, "warning"),
      title: zt(e.title, `stale_rules[${i}].title`)
    };
  });
}
function Oi(t, e, i) {
  ...
  for (const [s, n] of Object.entries(t)) {
    if (typeof n == "number") {
      ...
      at(n, i, `battery_thresholds.${s}`), r[s] = n;
      continue;
    }
    if (!$(n))
...
function Hi(t, e, i, r) {
  ...
  return o || (r === "battery" ? i === "critical" ? "mdi:battery-alert" : "mdi:battery-low" : i === "critical" ? "mdi:alert-octagon" : i === "warning" ? "mdi:alert" : Pi[Ht(e)] ?? "mdi:information-outline");
}
function Li(t, e) {
  const i = Lt(t, e);
  for (const r of i) {
...
function Lt(t, e) {
  ...
  te(i, r == null ? void 0 : r.area_id);
  const s = ee(t, e), n = s ? He(t, s) : void 0;
  te(i, n == null ? void 0 : n.area_id);
  const o = t.states[e], a = o == null ? void 0 : o.attributes.area;
  typeof a == "string" && te(i, a);
  for (const c of [...i]) {
    const d = jt(t, c);
    te(i, d == null ? void 0 : d.name);
  }
  return [...i];
}
function ee(t, e) {
...
function ze(t, e) {
  var n, o;
  const i = new Set(((o = (n = t.entities) == null ? void 0 : n[e]) == null ? void 0 : o.labels) ?? []), r = ee(t, e), s = r ? He(t, r) : void 0;
...
function pe(t) {
  const e = t.hass.states[t.entityId], i = ee(t.hass, t.entityId), r = t.activeSinceMs ?? P(e == null ? void 0 : e.last_changed) ?? P(e == null ? void 0 : e.last_updated) ?? Date.now();
  return {
    id: t.id,
    entity_id: t.entityId,
    severity: t.severity,
    title: t.title ?? zi(t.hass, t.entityId),
    message: t.message,
    state: (e == null ? void 0 : e.state) ?? "missing",
    activeSinceMs: r,
    area: Li(t.hass, t.entityId),
    deviceId: i,
    deviceName: ji(t.hass, t.entityId),
    icon: Hi(t.hass, t.entityId, t.severity, t.source),
    source: t.source,
    actions: t.actions
  };
}
...
function Vt(t, e) {
  return e.wildcard ? Object.keys(t.states).filter((i) => Bt(i, e)) : t.states[e.pattern] ? [e.pattern] : [];
}
function Bi(t) {
  return {
    ...
    patterns: t.patterns.map(Te)
  };
}
function fe(t, e, i) {
  if (i.entities.has(t) || i.domains.has(Ht(t)) || i.patterns.some((n) => Bt(t, n)) || ze(e, t).some((n) => i.labels.has(n)))
    return !0;
  const r = ee(e, t);
  return r && i.devices.has(r) ? !0 : Lt(e, t).some(
...
function qi(t) {
  ...
  for (const [n, o] of Object.entries(t.hass.states)) {
    if (n === e.battery_warning_entity || n === e.battery_critical_entity || !Gi(n, o) || !Ft(n, t.hass, e.include.labels) || fe(n, t.hass, i))
      continue;
    const a = he(o.state);
    if (a === void 0)
      continue;
    ...
    s.push(
      pe({
        ...
        entityId: n,
        severity: c,
        message: `Battery is ${Zi(a)}% (${c} below ${d}%)`,
        activeSinceMs: P(o.last_changed),
        source: "battery",
        id: `battery:${n}`
      })
    );
...
function Gi(t, e) {
  ...
  return i === "battery" || typeof r == "string" && r.trim() === "%" && lt.some((s) => s.test(t)) ? !0 : lt.some((s) => s.test(t));
}
function Ki(t, e, i) {
...
function Xi(t) {
  ...
  for (const s of t.plan.staleRules) {
    const n = Vt(t.hass, s.matcher);
    for (const o of n)
      r.add(o), ut(t, o, s.rule, e, i);
  }
...
function ut(t, e, i, r, s) {
  if (s.has(e) || fe(e, t.hass, t.plan.exclusions))
    return;
  const n = t.hass.states[e];
  if (!n)
    return;
  const o = P(n.last_updated) ?? P(n.last_changed);
  if (o === void 0)
    return;
  const a = i.hours * Qi, l = o + a;
  t.now.getTime() < l || (s.add(e), r.push(
    pe({
      ...
      title: i.title,
      message: `No update for ${er(i.hours)}`,
      activeSinceMs: l,
      source: "stale",
      id: `stale:${e}`
    })
...
function tr(t) {
  ...
  if (e.startup_grace_minutes > 0 && t.now.getTime() < r + e.startup_grace_minutes * dt)
    return [];
  const s = [];
  for (const [n, o] of Object.entries(t.hass.states)) {
    const a = o.state === "unknown", l = o.state === "unavailable";
    if (!a && !l || a && !e.detect_unknown || l && !e.detect_unavailable || !Ft(n, t.hass, i.labels) || fe(n, t.hass, t.plan.exclusions))
      continue;
    const c = a ? e.unknown_for_minutes : e.unavailable_for_minutes, u = (P(o.last_changed) ?? t.now.getTime()) + c * dt;
    if (t.now.getTime() < u)
      continue;
...
function rr(t) {
  ...
  for (const r of t.plan.userRules) {
    ...
    if (r.matcher)
      for (const n of Vt(t.hass, r.matcher))
        s.add(n);
    if (r.label)
      for (const n of Vi(t.hass, r.label))
        s.add(n);
    for (const n of s) {
      const o = cr(r.index, n);
...
function sr(t, e, i, r, s) {
  const n = nr(t, e, i, r, s);
  if (!n.matched)
    return G(r, s), { matched: !1 };
  const o = r.now.getTime(), a = r.ruleDurationMemory.firstMatchedAtMs.get(s) ?? ar(t, e, o);
  r.ruleDurationMemory.firstMatchedAtMs.set(s, a);
  const l = (t.for_minutes ?? 0) * ir, c = a + l;
  return l > 0 && o < c ? { matched: !1 } : (lr(t) && r.ruleDurationMemory.activeHysteresisKeys.add(s), {
    matched: !0,
    message: n.message,
    activeSinceMs: c
  });
...
function nr(t, e, i, r, s) {
  ...
  const a = ht(t.above, t.above_entity, "above", i, r), l = ht(t.below, t.below_entity, "below", i, r);
  ...
  if (a.value !== void 0 && d !== void 0) {
    ...
    if (!(u && t.clear_below !== void 0 ? d >= t.clear_below : d > a.value))
      return { matched: !1 };
    o.push(
      u && t.clear_below !== void 0 ? `${z(t)} ${ie(d)} has not cleared below ${t.clear_below}` : `${z(t)} ${ie(d)} is above ${a.value}`
    );
  }
  if (l.value !== void 0 && d !== void 0) {
    ...
    if (!(u && t.clear_above !== void 0 ? d <= t.clear_above : d < l.value))
      return { matched: !1 };
    o.push(
      u && t.clear_above !== void 0 ? `${z(t)} ${ie(d)} has not cleared above ${t.clear_above}` : `${z(t)} ${ie(d)} is below ${l.value}`
    );
  }
  return {
    matched: !0,
...
function ar(t, e, i) {
  return t.attribute === void 0 && t.above === void 0 && t.above_entity === void 0 && t.below === void 0 && t.below_entity === void 0 && (t.state !== void 0 || t.not_state !== void 0) ? P(e.last_changed) ?? i : i;
}
function lr(t) {
...
function Be(t) {
  return {
    config: t,
    exclusions: Bi(t.exclude),
    userRules: t.rules.map((e, i) => ({
      rule: e,
      matcher: e.entity_id ? Te(e.entity_id) : void 0,
      label: e.label,
      index: i
    })),
    staleRules: t.stale_rules.map((e, i) => ({
      rule: e,
      matcher: Te(e.entity_id),
      index: i
    }))
  };
}
...
function dr(t, e, i = /* @__PURE__ */ new Date(), r = {}) {
  return Ve(t, e, i, r).issues;
}
function Ve(t, e, i = /* @__PURE__ */ new Date(), r = {}) {
  const s = {
    hass: t,
    plan: e,
    now: i,
    connectedAtMs: r.connectedAtMs,
    ruleDurationMemory: r.ruleDurationMemory ?? Re(),
  ...
  return {
    issues: je(hr(n), e.config.reverse_age_sort),
    diagnostics: [...s.diagnostics.values()]
  };
}
function Tr(t, e, i = /* @__PURE__ */ new Date(), r = {}) {
  const s = de(e);
  return dr(t, Be(s), i, r);
}
function kr(t, e, i = /* @__PURE__ */ new Date(), r = {}) {
  const s = de(e);
  return Ve(t, Be(s), i, r);
}
function hr(t) {
...
const ne = 60 * 1e3, K = 60 * ne, Ee = 24 * K;
function pr(t, e = Date.now()) {
  ...
  if (i < Ee) {
    const n = Math.floor(i / K), o = Math.floor(i % K / ne);
    return o > 0 ? `${n}h ${o}m` : `${n}h`;
  }
  const r = Math.floor(i / Ee), s = Math.floor(i % Ee / K);
  return s > 0 ? `${r}d ${s}h` : `${r}d`;
}
const _t = ["unavailable", "battery", "stale", "rule"];
function vt(t, e) {
  const i = new Set(e.show_severities), r = new Set(e.show_sources), s = je(
    t.filter((c) => i.has(c.severity) && r.has(c.source)),
    e.reverse_age_sort
  ), n = s.slice(0, e.max_issues ?? s.length), o = mt(s, e.group_by, e.reverse_age_sort), a = new Map(
    mt(n, e.group_by, e.reverse_age_sort).map((c) => [
      c.key,
      c
    ])
  ), l = o.flatMap((c) => {
    const d = a.get(c.key);
    return d && d.issues.length > 0 ? [{ ...c, issues: d.issues }] : [];
  });
  return {
    matchingIssues: s,
    visibleIssues: n,
    groups: l,
    hiddenCount: s.length - n.length
  };
}
function mt(t, e, i) {
  if (e === "none")
  ...
  const r = /* @__PURE__ */ new Map();
  for (const s of t) {
    const n = fr(s, e), o = r.get(n.key) ?? { label: n.label, issues: [] };
...
function _r(t, e, i) {
  return i === "severity" ? ce(t.key) - ce(e.key) : i === "source" ? _t.indexOf(t.key) - _t.indexOf(e.key) : t.label.localeCompare(e.label, void 0, { sensitivity: "base" });
}
function gt(t) {
...
`;
var gr = Object.defineProperty, br = Object.getOwnPropertyDescriptor, F = (t, e, i, r) => {
  for (var s = r > 1 ? void 0 : r ? br(e, i) : e, n = t.length - 1, o; n >= 0; n--)
    (o = t[n]) && (s = (r ? o(e, i, s) : o(s)) || s);
  return r && s && gr(e, i, s), s;
};
const Jt = "attention-center-card", yr = "attention-center-card-editor";
let M = class extends j {
  constructor() {
    super(...arguments), this._diagnostics = [], this._presentation = {
      ...
      groups: [],
      hiddenCount: 0
    }, this._configKey = "", this._lastConfigKey = "", this._ruleDurationMemory = Re(), this._nowMs = Date.now();
  }
  setConfig(t) {
    const e = de(t);
    this._config = e, this._plan = Be(e), this._configKey = Mi(e), this._lastConfigKey = "", this._lastStatesRef = void 0, this._lastEntitiesRef = void 0, this._lastDevicesRef = void 0, this._lastAreasRef = void 0, this._ruleDurationMemory = Re(), this._presentation = vt([], e), this._diagnostics = [], this._actionError = void 0, this._recalculateIssues();
  }
  ...
  static async getConfigElement() {
    return await Promise.resolve().then(() => Er), document.createElement(yr);
  }
  getCardSize() {
  ...
  render() {
    ...
    if (this._presentation.matchingIssues.length === 0 && this._config.empty_state === "hide")
      return v;
    const t = ft(this._presentation.matchingIssues), e = this._presentation.matchingIssues.length;
    return _`
      <ha-card>
        <div class="header">
          <div class="title-row">
  ...
  _renderBody() {
    if (!this._config)
      return _``;
    const t = ft(this._presentation.matchingIssues);
  ...
  _renderIssue(t) {
    const e = pr(t.activeSinceMs, this._nowMs);
    return _`
  ...
  _recalculateIssues(t = !1) {
    ...
    const e = Ve(this.hass, this._plan, new Date(this._nowMs), {
      ruleDurationMemory: this._ruleDurationMemory,
      connectedAtMs: this._connectedAtMs
    });
    this._diagnostics = e.diagnostics, this._presentation = vt(e.issues, this._plan.config), this._lastStatesRef = this.hass.states, this._lastEntitiesRef = this.hass.entities, this._lastDevicesRef = this.hass.devices, this._lastAreasRef = this.hass.areas, this._lastConfigKey = this._configKey;
  }
  _startMinuteTimer() {
  ...
  async _handleAction(t, e, i) {
    if (t.stopPropagation(), !!this.hass) {
      ...
      try {
        await $i(this.hass, e.entity_id, i, {
...
var $r = Object.defineProperty, wr = Object.getOwnPropertyDescriptor, T = (t, e, i, r) => {
  for (var s = r > 1 ? void 0 : r ? wr(e, i) : e, n = t.length - 1, o; n >= 0; n--)
    (o = t[n]) && (s = (r ? o(e, i, s) : o(s)) || s);
  return r && s && $r(e, i, s), s;
};
let w = class extends j {
  ...
  setConfig(t) {
    ...
    }, this._rulesText = wt(this._config.rules ?? []), this._staleRulesText = wt(this._config.stale_rules ?? []), this._rulesError = void 0, this._staleRulesError = void 0, this._configError = void 0;
  }
  render() {
    const t = {
      ...h.exclude,
    ...
    return _`
        ...
        <div class="section row">
          ...
          <div>
            ...
            <input
              ...
              @change=${(r) => this._setConfigValue("max_issues", Ar(r))}
            />
          </div>
        </div>
      ...
      (r) => this._renderArrayCheckbox(
        ...
        <div class="section">
          ...
          <textarea
            id="collapsed-groups"
            .value=${re(this._config.collapsed_groups)}
            @change=${(r) => this._setConfigValue("collapsed_groups", $t(g(r)))}
          ></textarea>
        </div>
        ...
        <div class="section">
          ...
          <ha-selector
            ...
            .value=${e.labels}
            @value-changed=${(r) => this._setIncludeLabels(yt(r))}
          ></ha-selector>
        </div>
        ...
        <div class="section">
          ...
          <ha-selector
            ...
            .selector=${{ label: { multiple: !0 } }}
            .value=${t.labels}
            @value-changed=${(r) => this._setExcludeLabels(yt(r))}
          ></ha-selector>
        </div>
  ...
  _setJsonText(t, e) {
    t === "rules" ? (this._rulesText = e, this._rulesError = Me(e).error) : (this._staleRulesText = e, this._staleRulesError = Me(e).error);
  }
  _setJsonRules(t, e) {
    const i = Me(e);
...
T([
  A()
], w.prototype, "_rulesError", 2);
T([
  A()
], w.prototype, "_staleRulesError", 2);
T([
  A()
], w.prototype, "_configError", 2);
w = T([
  kt("attention-center-card-editor")
], w);
function g(t) {
...
export {
  ...
  dr as evaluateAttentionIssues,
  Tr as evaluateAttentionIssuesForConfig,
  Ve as evaluateAttentionResult,
  kr as evaluateAttentionResultForConfig,
  vt as prepareIssuePresentation
};
